...
from new_dataset import SASRecDataset, OODDataset
...
def main():
    ...
    parser.add_argument('--output_dir', default='output/tests1/', type=str)
    parser.add_argument('--data_name', default='Scientific', type=str)
    ...
    parser.add_argument("--gap", type=int, default=0, help="TODO")
    ...
    train_dataset = OODDataset(args, user_seq, data_type='train')
    train_sampler = RandomSampler(train_dataset)
    train_dataloader = DataLoader(train_dataset, sampler=train_sampler, batch_size=args.batch_size)

    eval_dataset = OODDataset(args, user_seq, data_type='valid')
    eval_sampler = SequentialSampler(eval_dataset)
    eval_dataloader = DataLoader(eval_dataset, sampler=eval_sampler, batch_size=args.batch_size)

    test_dataset = OODDataset(args, user_seq, data_type='test')
